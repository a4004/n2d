...
namespace N2D.Components
{
    partial class ProgressStrip
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.AnimationSeq = new Timer(this.components);
            this.SuspendLayout();
            // 
            // AnimationSeq
            // 
            ...
            this.AnimationSeq.Tick += new EventHandler(this.AnimationSeq_Tick);
            // 
            // ProgressStrip
            // 
    ...
    public partial class ProgressStrip : UserControl
    {
        ...
        internal class RegularMode
        {
            ...
            public static int ResetOffset = -300;
        }
        /// <summary>
        /// Marquee Properties
        /// </summary>
        internal class Marquee
        {
            ...
            public static int Position = -300;
            public static int ResetOffset = -50;
        }

        /// <summary>
        /// Defines the background color of the control
        /// </summary>
        public override Color BackColor { get; set; } = Color.FromArgb(24, 24, 24);
        /// <summary>
        /// Defines the value (foreground) color of the control
        /// </summary>
        public override Color ForeColor { get; set; } = Color.FromArgb(0, 100, 225);
        /// <summary>
        /// Defines the highlight (glow) color of the control
        /// </summary>
        public Color GlowColor { get; set; } = Color.FromArgb(25, 125, 250);
        ...
        /// <summary>
        /// Determines the marquee reset offset
        /// </summary>
        [Obsolete]
        public int ResetOffsetMarquee
        {
            get
            {
                return Marquee.ResetOffset;     // return the value of the reset offset.
            }
            set
            {
                Marquee.ResetOffset = value;    // set the value of the reset offset.
            }
        }

        /// <summary>
        /// Determines the regular glow reset offset
        /// </summary>
        [Obsolete]
        public int ResetOffsetGlow
        {
            get
            {
                return RegularMode.ResetOffset;     // return the value of the reset offset.
            }
            set
            {
                RegularMode.ResetOffset = value;    // set the value of the reset offset.
            }
        }
        ...
        private void DrawGlowEffect(Graphics g)
        {
            Rectangle rect = new                                        // create new rectangle.
                Rectangle(RegularMode.Position, 0, 60, this.Height);
            ...
            if (Mode is ControlMode.Marquee)         // if marquee mode.
            {
                ...
                if (Marquee.Position                // if bar is beyond visible range.
                    ...
                    Marquee.Position =              // reset position.
                        -(-Marquee.ResetOffset + Marquee.Size);
            }
